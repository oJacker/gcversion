...
/**
 * HashesTempSearch represents the model behind the search form about `backend\models\HashesTemp`.
 */
class HashesTempSearch extends HashesTemp
{
    /**
     * @inheritdoc
     */
